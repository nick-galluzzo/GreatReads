...
# Review
Review.create!(comment: 'Great book!', rating: 5, user_id: User.first.id, book_id: Book.first.id)
Review.create!(comment: 'Amazing!', rating: 5, user_id: User.second.id, book_id: Book.first.id)
